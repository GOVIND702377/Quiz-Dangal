...
<h1 className="text-3xl font-bold bg-gradient-to-r from-violet-400 via-indigo-300 to-fuchsia-400 bg-clip-text text-transparent mb-4 pt-14">Contact Us</h1>
          ...
          {contactMethods.map((method, index) => (
            ...
            >
              <div className="text-center space-y-4">
                <div className={`bg-gradient-to-r ${getBrandGradient(index)} p-4 rounded-full w-16 h-16 mx-auto flex items-center justify-center ring-4 ring-white/10`}>
