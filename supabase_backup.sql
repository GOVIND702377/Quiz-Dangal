...
\restrict QR94i03qffVC4udsZDiqVecR5aJ1J9nE4oPSNivsQxeyHulr5jd1DF6ItQNqfla
...
DROP POLICY "Users can manage their own push subscriptions" ON public.push_subscriptions;
...
DROP POLICY "Results access policy" ON public.quiz_results;
DROP POLICY "Redemptions access for owners and admins" ON public.redemptions;
DROP POLICY "Quizzes access policy" ON public.quizzes;
DROP POLICY "Quiz prizes: service_role manage" ON public.quiz_prizes;
DROP POLICY "Questions access policy" ON public.questions;
DROP POLICY "Profiles are viewable by authenticated users" ON public.profiles;
DROP POLICY "Participants access for owners and admins" ON public.quiz_participants;
DROP POLICY "Options access policy" ON public.options;
DROP POLICY "Notifications access policy" ON public.notifications;
DROP POLICY "Daily streaks are viewable by authenticated users." ON public.daily_streaks;
...
DROP INDEX public.ix_push_subscriptions_user_id;
...
DROP FUNCTION public.join_quiz(p_user_id uuid, p_quiz_id uuid);
...
DROP FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer);
DROP FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer);
...
BEGIN
  ...
  v_entry_fee := COALESCE(v_quiz.entry_fee, 0);
  ...
  IF v_inserted > 0 AND v_entry_fee > 0 THEN
    INSERT INTO public.transactions (user_id, type, amount, status, description, reference_id)
    VALUES (v_user_id, 'debit', v_entry_fee, 'success', 'Quiz entry fee', p_quiz_id);
  ELSE
...
ea31fc50-cbfc-4fb0-81c5-35a8a9ae8469	2025-09-22 08:33:31.52758+00	2025-09-22 08:33:31.52758+00	otp	029f0bf8-f8e8-45a8-a45b-1082f21c2c38
...
00000000-0000-0000-0000-000000000000	428	fimgu2f5td6d	d54f5f83-aa63-4630-b9be-dbdca91b9315	f	2025-09-22 08:33:31.516735+00	2025-09-22 08:33:31.516735+00	\N	ea31fc50-cbfc-4fb0-81c5-35a8a9ae8469
...
ea31fc50-cbfc-4fb0-81c5-35a8a9ae8469	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-22 08:33:31.511029+00	2025-09-22 08:33:31.511029+00	\N	aal1	\N	\N	Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Mobile Safari/537.36 OPR/85.0.0.0	42.107.224.128	\N
\.
...
00000000-0000-0000-0000-000000000000	d54f5f83-aa63-4630-b9be-dbdca91b9315	authenticated	authenticated	sutharji1122@gmail.com	$2a$10$2FLTxBVrZh3j6vtwBT8H7ORjUx6mw5KG4vgojUfZnTsTX/IM05JV6	2025-08-23 14:49:34.875525+00	\N		\N		2025-09-22 08:33:15.311963+00			\N	2025-09-22 08:33:31.510956+00	{"provider": "email", "providers": ["email", "google"]}	{"iss": "https://accounts.google.com", "sub": "118002990807929691971", "name": "Govind", "email": "sutharji1122@gmail.com", "picture": "https://lh3.googleusercontent.com/a/ACg8ocIQKyDRHmvc2KvzlvpD3URLqVHjjxPTsl1pkuGfpieEsXdzejo=s96-c", "full_name": "Govind", "avatar_url": "https://lh3.googleusercontent.com/a/ACg8ocIQKyDRHmvc2KvzlvpD3URLqVHjjxPTsl1pkuGfpieEsXdzejo=s96-c", "provider_id": "118002990807929691971", "email_verified": true, "phone_verified": false}	\N	2025-08-23 14:49:34.758992+00	2025-09-22 08:33:31.527+00	\N	\N			\N		0	\N		\N	f	\N	f
\.
...
d54f5f83-aa63-4630-b9be-dbdca91b9315	Govind	user	2025-09-22 08:33:33.112776+00	sutharji1122@gmail.com	0	0	0	{}	active	2025-08-25 18:08:53.554728+00	Silver	gomu4300000	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/d54f5f83-aa63-4630-b9be-dbdca91b9315/1756577551350.jpg	t	f	d54f5f83	\N	3	5	2025-09-22		185
...
--
-- Data for Name: messages_2025_09_25; Type: TABLE DATA; Schema: realtime; Owner: -
--
...
SELECT pg_catalog.setval('realtime.subscription_id_seq', 1378, true);
...
--
-- Name: TABLE messages_2025_09_19; Type: ACL; Schema: realtime; Owner: -
--

GRANT ALL ON TABLE realtime.messages_2025_09_19 TO postgres;
GRANT ALL ON TABLE realtime.messages_2025_09_19 TO dashboard_user;


--
-- Name: TABLE messages_2025_09_20; Type: ACL; Schema: realtime; Owner: -
--

GRANT ALL ON TABLE realtime.messages_2025_09_20 TO postgres;
GRANT ALL ON TABLE realtime.messages_2025_09_20 TO dashboard_user;


--
-- Name: TABLE messages_2025_09_21; Type: ACL; Schema: realtime; Owner: -
--

GRANT ALL ON TABLE realtime.messages_2025_09_21 TO postgres;
GRANT ALL ON TABLE realtime.messages_2025_09_21 TO dashboard_user;


--
-- Name: TABLE messages_2025_09_22; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_23; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_24; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_25; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict QR94i03qffVC4udsZDiqVecR5aJ1J9nE4oPSNivsQxeyHulr5jd1DF6ItQNqfla
