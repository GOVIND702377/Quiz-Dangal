...
\restrict Qp51GipLqa7OSrgmDaX6H63QwBRnIBL73walSyiWaiMyFQRyeYVdjTZ0fsj3DFm
...
DROP POLICY avatars_auth_update_own ON storage.objects;
DROP POLICY avatars_auth_insert ON storage.objects;
DROP POLICY avatars_auth_delete_own ON storage.objects;
...
DROP POLICY "Avatars: user update own files" ON storage.objects;
DROP POLICY "Avatars: user insert own files" ON storage.objects;
DROP POLICY "Avatars: user delete own files" ON storage.objects;
DROP POLICY "Avatars: user can manage own files" ON storage.objects;
DROP POLICY "Avatars: authenticated read" ON storage.objects;
DROP POLICY "Authenticated users can upload avatars" ON storage.objects;
DROP POLICY streaks_select_own ON public.daily_streaks;
DROP POLICY streaks_insert_own ON public.daily_streaks;
DROP POLICY results_read_admin_or_participant ON public.quiz_results;
DROP POLICY levels_read_auth ON public.levels;
DROP POLICY admin_users_read_own ON public.admin_users;
DROP POLICY admin_users_manage_service_role ON public.admin_users;
DROP POLICY "Users can insert referrals" ON public.referrals;
DROP POLICY "User answers: update own" ON public.user_answers;
DROP POLICY "User answers: select own" ON public.user_answers;
DROP POLICY "User answers: leaderboard read (definer)" ON public.user_answers;
DROP POLICY "User answers: insert own" ON public.user_answers;
DROP POLICY "Transactions own" ON public.transactions;
DROP POLICY "Stats access for owners and admins" ON public.user_quiz_stats;
DROP POLICY "Reward catalog access policy" ON public.reward_catalog;
DROP POLICY "Referrals own" ON public.referrals;
DROP POLICY "Redemptions own" ON public.redemptions;
DROP POLICY "Quizzes read for auth" ON public.quizzes;
DROP POLICY "Quizzes admin update" ON public.quizzes;
DROP POLICY "Quizzes admin insert" ON public.quizzes;
DROP POLICY "Quizzes admin delete" ON public.quizzes;
DROP POLICY "Quiz prizes: service_role manage" ON public.quiz_prizes;
DROP POLICY "Questions read for auth" ON public.questions;
DROP POLICY "Questions admin update" ON public.questions;
DROP POLICY "Questions admin insert" ON public.questions;
DROP POLICY "Questions admin delete" ON public.questions;
DROP POLICY "Push: manage own" ON public.push_subscriptions;
...
DROP POLICY "Participants: update own or admin" ON public.quiz_participants;
DROP POLICY "Participants: read own or admin" ON public.quiz_participants;
DROP POLICY "Participants: insert own" ON public.quiz_participants;
DROP POLICY "Options read for auth" ON public.options;
DROP POLICY "Options admin update" ON public.options;
DROP POLICY "Options admin insert" ON public.options;
DROP POLICY "Options admin delete" ON public.options;
DROP POLICY "Notifications read auth" ON public.notifications;
DROP POLICY "Notifications admin update" ON public.notifications;
DROP POLICY "Notifications admin insert" ON public.notifications;
DROP POLICY "Notifications admin delete" ON public.notifications;
DROP POLICY "Leaderboard read (server functions)" ON public.user_quiz_stats;
...
ALTER TABLE ONLY public.user_quiz_stats DROP CONSTRAINT user_quiz_stats_user_id_fkey;
ALTER TABLE ONLY public.user_quiz_stats DROP CONSTRAINT user_quiz_stats_quiz_id_fkey;
ALTER TABLE ONLY public.referrals DROP CONSTRAINT referrals_referrer_id_fkey;
ALTER TABLE ONLY public.referrals DROP CONSTRAINT referrals_referred_id_fkey;
ALTER TABLE ONLY public.redemptions DROP CONSTRAINT redemptions_user_id_fkey;
ALTER TABLE ONLY public.redemptions DROP CONSTRAINT redemptions_catalog_id_fkey;
ALTER TABLE ONLY public.quiz_results DROP CONSTRAINT quiz_results_quiz_id_fkey;
ALTER TABLE ONLY public.quiz_prizes DROP CONSTRAINT quiz_prizes_quiz_id_fkey;
ALTER TABLE ONLY public.quiz_participants DROP CONSTRAINT quiz_participants_quiz_id_fkey;
ALTER TABLE ONLY public.push_subscriptions DROP CONSTRAINT push_subscriptions_user_id_fkey;
ALTER TABLE ONLY public.profiles DROP CONSTRAINT profiles_referred_by_fkey;
ALTER TABLE ONLY public.profiles DROP CONSTRAINT profiles_id_fkey;
ALTER TABLE ONLY public.notifications DROP CONSTRAINT notifications_quiz_id_fkey;
ALTER TABLE ONLY public.notifications DROP CONSTRAINT notifications_created_by_fkey;
ALTER TABLE ONLY public.user_answers DROP CONSTRAINT fk_user_answers_user;
ALTER TABLE ONLY public.user_answers DROP CONSTRAINT fk_user_answers_question;
ALTER TABLE ONLY public.user_answers DROP CONSTRAINT fk_user_answers_option;
ALTER TABLE ONLY public.transactions DROP CONSTRAINT fk_transactions_user;
ALTER TABLE ONLY public.quiz_results DROP CONSTRAINT fk_quiz_results_user;
ALTER TABLE ONLY public.quiz_results DROP CONSTRAINT fk_quiz_results_quiz;
ALTER TABLE ONLY public.quiz_prizes DROP CONSTRAINT fk_quiz_prizes_quiz;
ALTER TABLE ONLY public.quiz_participants DROP CONSTRAINT fk_quiz_participants_user;
ALTER TABLE ONLY public.quiz_participants DROP CONSTRAINT fk_quiz_participants_quiz;
ALTER TABLE ONLY public.questions DROP CONSTRAINT fk_questions_quiz;
ALTER TABLE ONLY public.options DROP CONSTRAINT fk_options_question;
ALTER TABLE ONLY public.daily_streaks DROP CONSTRAINT daily_streaks_user_id_fkey;
...
DROP TRIGGER trigger_update_profile_coins ON public.transactions;
DROP TRIGGER trigger_generate_referral_code ON public.profiles;
DROP TRIGGER trigger_auto_complete_quiz ON public.user_answers;
DROP TRIGGER trg_user_answers_updated_at ON public.user_answers;
DROP TRIGGER trg_user_answers_updated ON public.user_answers;
DROP TRIGGER trg_tx_sync_profiles ON public.transactions;
DROP TRIGGER trg_transactions_updated_at ON public.transactions;
DROP TRIGGER trg_transactions_updated ON public.transactions;
DROP TRIGGER trg_reward_referral ON public.profiles;
DROP TRIGGER trg_redemptions_updated_at ON public.redemptions;
DROP TRIGGER trg_redemptions_updated ON public.redemptions;
DROP TRIGGER trg_quizzes_updated_at ON public.quizzes;
DROP TRIGGER trg_quizzes_updated ON public.quizzes;
DROP TRIGGER trg_quizzes_finish_compute ON public.quizzes;
DROP TRIGGER trg_quiz_results_updated_at ON public.quiz_results;
DROP TRIGGER trg_quiz_results_updated ON public.quiz_results;
DROP TRIGGER trg_quiz_prizes_updated_at ON public.quiz_prizes;
DROP TRIGGER trg_quiz_prizes_updated ON public.quiz_prizes;
DROP TRIGGER trg_quiz_participants_updated_at ON public.quiz_participants;
DROP TRIGGER trg_quiz_participants_updated ON public.quiz_participants;
DROP TRIGGER trg_quiz_notifications ON public.quizzes;
DROP TRIGGER trg_quiz_finished_compute ON public.quizzes;
DROP TRIGGER trg_questions_updated_at ON public.questions;
DROP TRIGGER trg_questions_updated ON public.questions;
DROP TRIGGER trg_push_subscriptions_updated_at ON public.push_subscriptions;
DROP TRIGGER trg_profiles_updated_at ON public.profiles;
DROP TRIGGER trg_profiles_updated ON public.profiles;
DROP TRIGGER trg_profiles_generate_referral ON public.profiles;
DROP TRIGGER trg_profiles_block_role_change ON public.profiles;
DROP TRIGGER trg_options_updated_at ON public.options;
DROP TRIGGER trg_options_updated ON public.options;
DROP TRIGGER trg_assign_level ON public.profiles;
DROP TRIGGER trg_after_daily_streak_credit ON public.daily_streaks;
DROP TRIGGER on_profile_change ON public.profiles;
DROP TRIGGER trg_handle_new_user ON auth.users;
...
DROP INDEX public.ux_tx_daily_login_once_per_day;
DROP INDEX public.ux_profiles_username_lower;
DROP INDEX public.transactions_unique_quiz_join_debit;
DROP INDEX public.push_subscriptions_endpoint_idx;
DROP INDEX public.ix_user_quiz_stats_quiz_id;
DROP INDEX public.idx_user_quiz_stats_user_id_completed_at;
DROP INDEX public.idx_user_answers_user;
DROP INDEX public.idx_user_answers_selected_option_id;
DROP INDEX public.idx_user_answers_scoring;
DROP INDEX public.idx_user_answers_question;
DROP INDEX public.idx_tx_user_type_date;
DROP INDEX public.idx_transactions_user_created;
...
DROP INDEX public.idx_redemptions_catalog_id;
DROP INDEX public.idx_quizzes_times;
DROP INDEX public.idx_quizzes_status_times;
DROP INDEX public.idx_quizzes_status;
DROP INDEX public.idx_quiz_results_user_id;
DROP INDEX public.idx_quiz_results_quiz;
DROP INDEX public.idx_quiz_prizes_quiz_id;
DROP INDEX public.idx_quiz_participants_user;
DROP INDEX public.idx_quiz_participants_quiz_user;
DROP INDEX public.idx_quiz_participants_quiz;
DROP INDEX public.idx_questions_quiz_id;
DROP INDEX public.idx_push_subscriptions_user_id;
DROP INDEX public.idx_push_subscriptions_subscription_object_gin;
DROP INDEX public.idx_push_subscriptions_endpoint;
DROP INDEX public.idx_profiles_referred_by;
DROP INDEX public.idx_options_question_id;
DROP INDEX public.idx_options_correctness;
DROP INDEX public.idx_notifications_quiz_id;
DROP INDEX public.idx_notifications_created_by;
DROP INDEX public.idx_daily_streaks_user_date;
...
ALTER TABLE ONLY realtime.messages_2025_10_03 DROP CONSTRAINT messages_2025_10_03_pkey;
ALTER TABLE ONLY realtime.messages_2025_10_02 DROP CONSTRAINT messages_2025_10_02_pkey;
ALTER TABLE ONLY realtime.messages_2025_10_01 DROP CONSTRAINT messages_2025_10_01_pkey;
ALTER TABLE ONLY realtime.messages_2025_09_30 DROP CONSTRAINT messages_2025_09_30_pkey;
ALTER TABLE ONLY realtime.messages_2025_09_29 DROP CONSTRAINT messages_2025_09_29_pkey;
...
ALTER TABLE ONLY public.user_quiz_stats DROP CONSTRAINT user_quiz_stats_user_id_quiz_id_key;
ALTER TABLE ONLY public.user_quiz_stats DROP CONSTRAINT user_quiz_stats_pkey;
ALTER TABLE ONLY public.user_answers DROP CONSTRAINT user_answers_user_question_key;
ALTER TABLE ONLY public.user_answers DROP CONSTRAINT user_answers_pkey;
ALTER TABLE ONLY public.push_subscriptions DROP CONSTRAINT uniq_push_sub_user_endpoint;
ALTER TABLE ONLY public.transactions DROP CONSTRAINT transactions_pkey;
ALTER TABLE ONLY public.reward_catalog DROP CONSTRAINT reward_catalog_pkey;
ALTER TABLE ONLY public.referrals DROP CONSTRAINT referrals_referrer_id_referred_id_key;
...
ALTER TABLE ONLY public.quiz_results DROP CONSTRAINT quiz_results_quiz_id_key;
ALTER TABLE ONLY public.quiz_results DROP CONSTRAINT quiz_results_pkey;
ALTER TABLE ONLY public.quiz_prizes DROP CONSTRAINT quiz_prizes_pkey;
ALTER TABLE ONLY public.quiz_participants DROP CONSTRAINT quiz_participants_quiz_user_key;
ALTER TABLE ONLY public.quiz_participants DROP CONSTRAINT quiz_participants_pkey;
ALTER TABLE ONLY public.questions DROP CONSTRAINT questions_pkey;
ALTER TABLE ONLY public.push_subscriptions DROP CONSTRAINT push_subscriptions_pkey;
...
ALTER TABLE ONLY public.levels DROP CONSTRAINT levels_coins_required_key;
ALTER TABLE ONLY public.daily_streaks DROP CONSTRAINT daily_streaks_user_id_login_date_key;
ALTER TABLE ONLY public.daily_streaks DROP CONSTRAINT daily_streaks_pkey;
...
DROP TABLE realtime.messages_2025_10_03;
DROP TABLE realtime.messages_2025_10_02;
DROP TABLE realtime.messages_2025_10_01;
DROP TABLE realtime.messages_2025_09_30;
DROP TABLE realtime.messages_2025_09_29;
DROP TABLE realtime.messages_2025_09_28;
DROP TABLE realtime.messages_2025_09_27;
DROP TABLE realtime.messages;
DROP TABLE public.user_quiz_stats;
DROP TABLE public.user_answers;
DROP TABLE public.transactions;
DROP TABLE public.reward_catalog;
DROP TABLE public.referrals;
DROP TABLE public.redemptions;
DROP TABLE public.quiz_prizes;
DROP TABLE public.questions;
DROP TABLE public.push_subscriptions;
DROP TABLE public.profiles;
DROP TABLE public.options;
DROP TABLE public.notifications;
DROP VIEW public.my_quizzes_view;
DROP TABLE public.quizzes;
DROP TABLE public.quiz_results;
DROP TABLE public.quiz_participants;
...
DROP FUNCTION public.update_user_claims();
DROP FUNCTION public.update_updated_at_column();
DROP FUNCTION public.update_profile_coins();
DROP FUNCTION public.trg_tx_sync_profiles();
DROP FUNCTION public.trg_quiz_notifications();
DROP FUNCTION public.trg_quiz_finished_compute();
DROP FUNCTION public.set_updated_at();
DROP FUNCTION public.save_push_subscription(p_subscription_object jsonb);
DROP FUNCTION public.reward_referral();
DROP FUNCTION public.reject_redemption(p_redemption_id uuid, p_reason text);
DROP FUNCTION public.reject_latest_redemption(p_email text, p_reward_value text, p_reason text);
DROP FUNCTION public.redeem_reward(p_user_id uuid, p_reward_type text, p_reward_value text, p_coins_required integer);
DROP FUNCTION public.redeem_from_catalog(p_user_id uuid, p_catalog_id uuid);
DROP FUNCTION public.profiles_public_by_ids(p_ids uuid[]);
DROP FUNCTION public.process_pending_quizzes();
DROP FUNCTION public.jwt_claim(claim text);
DROP FUNCTION public.join_quiz(p_quiz_id uuid);
DROP FUNCTION public.is_username_available(p_username text, p_exclude uuid);
DROP FUNCTION public.is_quiz_member(p_quiz_id uuid);
DROP FUNCTION public.is_own_profile(p_profile_id uuid);
DROP FUNCTION public.is_admin();
DROP FUNCTION public.handle_referral_bonus(referred_user_uuid uuid, referrer_code text);
DROP FUNCTION public.handle_new_user();
DROP FUNCTION public.handle_daily_login(user_uuid uuid);
DROP FUNCTION public.get_participant_count(p_quiz_id uuid);
DROP FUNCTION public.get_next_level_info(p_user_id uuid);
DROP FUNCTION public.get_my_claim_text(claim text);
DROP FUNCTION public.get_my_claim(claim text);
DROP FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer);
DROP FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer);
DROP FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer);
DROP FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer);
DROP FUNCTION public.generate_referral_code();
DROP FUNCTION public.delete_push_subscription(p_endpoint text);
DROP FUNCTION public.create_notification(p_title text, p_message text, p_type text, p_quiz_id uuid, p_scheduled_at timestamp with time zone);
DROP FUNCTION public.compute_results_wrapper();
DROP FUNCTION public.compute_quiz_results(p_quiz_id uuid);
DROP FUNCTION public.cleanup_old_data();
DROP FUNCTION public.block_role_change_if_not_admin();
DROP FUNCTION public.auto_complete_quiz_participant();
DROP FUNCTION public.assign_level();
DROP FUNCTION public.approve_redemption(p_redemption_id uuid);
DROP FUNCTION public.approve_latest_redemption(p_email text, p_reward_value text);
DROP FUNCTION public.after_daily_streak_credit();
DROP FUNCTION public.admin_recompute_quiz_results(p_quiz_id uuid);
DROP FUNCTION public.add_credit(p_user_id uuid, p_type text, p_amount integer, p_desc text);
DROP FUNCTION public._tx_is_credit(t text);
DROP FUNCTION pgtle."supabase-dbdev.control"();
DROP FUNCTION pgtle."supabase-dbdev--0.0.4.sql"();
DROP FUNCTION pgtle."supabase-dbdev--0.0.3.sql"();
DROP FUNCTION pgtle."supabase-dbdev--0.0.2.sql"();
...
DROP EXTENSION "supabase-dbdev";
DROP FUNCTION pgtle."supabase-dbdev--0.0.5.sql"();
...
CREATE FUNCTION public._tx_is_credit(t text) RETURNS boolean
    ...
    AS $$
  select lower(coalesce(t, '')) in (
    'credit','reward','bonus','referral','daily_login','quiz_reward','refund','prize'
  );
$$;
...
--
-- Name: admin_recompute_quiz_results(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.admin_recompute_quiz_results(p_quiz_id uuid) RETURNS TABLE(result_id uuid, result_quiz_id uuid, leaderboard jsonb, created_at timestamp with time zone, result_shown_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
begin
  if not public.is_admin() then
    raise exception 'Only admin can recompute results';
  end if;
  return query select * from public.compute_quiz_results(p_quiz_id);
end;$$;
...
begin
  ...
  -- Idempotent: ensure only one daily_login transaction per day
  select exists (
    select 1
    from public.transactions t
    where t.user_id = NEW.user_id
      and t.type = 'daily_login'
      and (t.created_at at time zone 'UTC')::date = current_date
  ) into has_credit;

  if not has_credit then
    v_desc := 'Daily login streak day ' || coalesce(NEW.streak_day, 1);
    -- Prefer coins_earned column; else compute 10 + 5*(day-1) capped at 50
    v_amount := coalesce(nullif(NEW.coins_earned, 0),
                         least(50, 10 + greatest(coalesce(NEW.streak_day, 1) - 1, 0) * 5));
    begin
      perform public.add_credit(NEW.user_id, 'daily_login', v_amount, v_desc);
    exception when unique_violation then
      -- In case of race: another path credited first; ignore
      null;
    end;
  end if;
...
--
-- Name: auto_complete_quiz_participant(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.auto_complete_quiz_participant() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
BEGIN
    -- When a user submits their last answer, mark them as completed
    IF TG_OP = 'INSERT' OR TG_OP = 'UPDATE' THEN
        -- Check if user has answered all questions for this quiz
        DECLARE
        ...
        BEGIN
            ...
            SELECT q.quiz_id INTO quiz_id_val 
            ...
            -- Count answered questions by this user
            SELECT COUNT(DISTINCT ua.question_id) INTO answered_questions
            FROM public.user_answers ua
            JOIN public.questions q ON q.id = ua.question_id
            WHERE ua.user_id = NEW.user_id AND q.quiz_id = quiz_id_val;
            
            -- If all questions answered, mark as completed
            IF answered_questions >= total_questions THEN
                UPDATE public.quiz_participants 
                SET status = 'completed' 
                WHERE user_id = NEW.user_id AND quiz_id = quiz_id_val;
            END IF;
        END;
    END IF;
...
--
-- Name: block_role_change_if_not_admin(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.block_role_change_if_not_admin() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
begin
...
CREATE FUNCTION public.cleanup_old_data() RETURNS void
    ...
    AS $$
BEGIN
    -- Delete old daily streaks (older than 1 year)
    ...
    -- Archive old quiz results (older than 2 years)
    -- This is just a placeholder - implement archiving as needed
...
declare
  ...
  rnk int := 0;
begin
  -- Score per participant = number of correct answers submitted for that quiz
  v_board := (
    with qa as (
      select ua.user_id,
      ...
      select qa.user_id,
             qa.score,
             coalesce('@' || p.username, p.full_name, p.username, 'User') as display_name
      from qa
      join public.profiles p on p.id = qa.user_id
    ), ranked as (
      select e.*, row_number() over (order by e.score desc, e.user_id) as rk
      from enriched e
    )
  ...
  insert into public.quiz_results(quiz_id, leaderboard, created_at, result_shown_at)
  values (p_quiz_id, coalesce(v_board, '[]'::jsonb), v_now, null)
  on conflict (quiz_id) do update set leaderboard = excluded.leaderboard, created_at = excluded.created_at
  returning id, quiz_id, leaderboard, created_at, result_shown_at into result_id, result_quiz_id, leaderboard, created_at, result_shown_at;
...
--
-- Name: compute_results_wrapper(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.compute_results_wrapper() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'public', 'pg_temp'
    AS $$
begin
...
begin
  ...
  insert into public.notifications (title, message, type, quiz_id, scheduled_at)
  values (p_title, p_message, p_type, p_quiz_id, p_scheduled_at)
  ...
  DELETE FROM public.push_subscriptions
   WHERE
     (
       ...
       OR (subscription_object->>'endpoint') = p_endpoint
     )
...
COMMENT ON FUNCTION public.delete_push_subscription(p_endpoint text) IS 'Deletes a specific web push subscription by endpoint. Current user, or admin.';
...
CREATE FUNCTION public.generate_referral_code() RETURNS trigger
    ...
    AS $$
begin
  if new.referral_code is null or length(coalesce(new.referral_code,'')) < 4 then
...
--
-- Name: get_all_time_leaderboard(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_all_time_leaderboard(limit_rows integer DEFAULT 100, offset_rows integer DEFAULT 0, max_streak_limit integer DEFAULT 30) RETURNS TABLE(user_id uuid, username text, full_name text, avatar_url text, leaderboard_score numeric, win_rate numeric, streak integer, rank integer)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
  select * from public.get_leaderboard_v2('all_time', limit_rows, offset_rows, max_streak_limit);
$$;


--
-- Name: get_all_time_leaderboard_v2(integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer DEFAULT 100, offset_rows integer DEFAULT 0, max_streak_limit integer DEFAULT 30) RETURNS TABLE(user_id uuid, username text, full_name text, avatar_url text, leaderboard_score numeric, win_rate numeric, streak integer, rank integer)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
  select * from public.get_leaderboard_v2('all_time', limit_rows, offset_rows, max_streak_limit);
...
--
-- Name: get_leaderboard(text, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_leaderboard(p_period text, limit_rows integer DEFAULT 100, offset_rows integer DEFAULT 0, max_streak_limit integer DEFAULT 30) RETURNS TABLE(user_id uuid, username text, full_name text, avatar_url text, leaderboard_score numeric, win_rate numeric, streak integer, rank integer)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
  select * from public.get_leaderboard_v2(p_period, limit_rows, offset_rows, max_streak_limit);
$$;


--
-- Name: get_leaderboard_v2(text, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer DEFAULT 100, offset_rows integer DEFAULT 0, max_streak_limit integer DEFAULT 30) RETURNS TABLE(user_id uuid, username text, full_name text, avatar_url text, leaderboard_score numeric, win_rate numeric, streak integer, rank integer)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
with period_params as (
  select
    case
      when lower(p_period) = 'weekly'  then (current_date - interval '6 days')::date
      when lower(p_period) = 'monthly' then (current_date - interval '29 days')::date
      else null::date
    end as start_date,
    case
      when lower(p_period) = 'weekly'  then 20
      when lower(p_period) = 'monthly' then 80
      else 80
    end as threshold,
    case
      when lower(p_period) = 'weekly'  then 7
      when lower(p_period) = 'monthly' then 30
      else 30
    end as default_streak_cap
),
cap as (
  select pp.start_date, pp.threshold,
         case when coalesce(max_streak_limit, 0) > 0 then max_streak_limit else pp.default_streak_cap end as streak_cap
  from period_params pp
),
answers as (
  select ua.user_id,
         sum(case when o.is_correct then 1 else 0 end)::numeric as correct,
         count(*)::numeric as attempted
  from public.user_answers ua
  join public.options o on o.id = ua.selected_option_id
  join cap c on true
  where c.start_date is null or ua.answered_at::date >= c.start_date
  group by ua.user_id
),
scored as (
  select p.id as user_id,
         ...
         c.threshold,
         c.streak_cap,
         greatest(0, least(coalesce(p.current_streak,0), c.streak_cap))::int as streak_norm
...
finals as (
  select
    ...
    case when s.attempted > 0 then (s.correct * 100.0 / s.attempted) else 0 end as accuracy,
    case when s.threshold > 0 then least(s.attempted / s.threshold::numeric, 1) else 0 end as participation_factor,
    s.streak_norm,
    s.streak_cap
  from scored s
),
scored2 as (
  select
    f.user_id, f.username, f.full_name, f.avatar_url,
    f.accuracy as win_rate,
    (f.accuracy * f.participation_factor) as effective_accuracy,
    case
      when f.streak_cap > 0 then (f.streak_norm * 100.0 / f.streak_cap)
      else 0
    end as streak_score,
    f.streak_norm as streak
  from finals f
),
ranked as (
  select
    s2.user_id, s2.username, s2.full_name, s2.avatar_url,
    (0.7 * s2.effective_accuracy + 0.3 * s2.streak_score) as leaderboard_score,
    s2.win_rate,
    s2.streak,
    row_number() over (order by (0.7 * s2.effective_accuracy + 0.3 * s2.streak_score) desc,
                               s2.win_rate desc,
                               s2.streak desc,
                               s2.user_id) as rk
  from scored2 s2
...
select user_id, username, full_name, avatar_url,
       leaderboard_score, win_rate, streak,
       rk::int as rank
from ranked
order by rk
...
--
-- Name: FUNCTION get_my_claim(claim text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_my_claim(claim text) IS 'Returns the given JWT claim as jsonb (or null).';


--
-- Name: get_my_claim_text(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_my_claim_text(claim text) RETURNS text
    LANGUAGE sql STABLE
    SET search_path TO 'public'
    AS $$
  select nullif(current_setting('request.jwt.claims', true), '')::jsonb ->> claim;
...
--
-- Name: get_next_level_info(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_next_level_info(p_user_id uuid) RETURNS TABLE(current_level integer, next_level integer, coins_required_next integer, coins_have numeric, coins_remaining numeric)
    LANGUAGE sql STABLE
    SET search_path TO 'public', 'pg_temp'
    AS $$
  with me as (
...
CREATE FUNCTION public.get_participant_count(p_quiz_id uuid) RETURNS integer
  ...
  WHERE quiz_id = p_quiz_id
    AND COALESCE(status, 'joined') = 'joined';
$$;
...
CREATE FUNCTION public.handle_daily_login(user_uuid uuid) RETURNS json
    ...
    AS $$
declare
  v_user uuid := coalesce(user_uuid, public.get_my_claim_text('sub')::uuid);
...
begin
  ...
  -- Already logged in today? Return existing
  ...
  -- Continue streak if logged in yesterday, else start from 1
...
CREATE FUNCTION public.handle_referral_bonus(referred_user_uuid uuid, referrer_code text) RETURNS json
    ...
    AS $$
declare
  v_referred uuid := coalesce(referred_user_uuid, get_my_claim_text('sub')::uuid);
  v_referrer uuid;
  v_created boolean := false;
  v_bonus_referrer int := 20;
  v_bonus_referred int := 10;
begin
  if v_referred is null then raise exception 'Not authenticated'; end if;
  if coalesce(trim(referrer_code),'') = '' then return json_build_object('ok', false, 'created', false); end if;

  select id into v_referrer from public.profiles where lower(referral_code) = lower(referrer_code) limit 1;
  if v_referrer is null or v_referrer = v_referred then
    return json_build_object('ok', false, 'created', false);
  end if;

  -- Already referred?
  if exists (select 1 from public.referrals where referrer_id = v_referrer and referred_id = v_referred) then
    return json_build_object('ok', true, 'created', false);
  end if;

  insert into public.referrals(referrer_id, referred_id) values (v_referrer, v_referred);
  v_created := true;

  -- Credit both parties (idempotent-ish via description uniqueness)
  if not exists (select 1 from public.transactions where user_id = v_referrer and type='referral' and description = ('Bonus for ref '||v_referred)::text) then
    insert into public.transactions(user_id, type, amount, description) values (v_referrer, 'referral', v_bonus_referrer, ('Bonus for ref '||v_referred)::text);
    update public.profiles set coins = coins + v_bonus_referrer where id = v_referrer;
  end if;
  if not exists (select 1 from public.transactions where user_id = v_referred and type='referral' and description = ('Welcome via '||v_referrer)::text) then
    insert into public.transactions(user_id, type, amount, description) values (v_referred, 'referral', v_bonus_referred, ('Welcome via '||v_referrer)::text);
    update public.profiles set coins = coins + v_bonus_referred where id = v_referred;
  end if;
...
CREATE FUNCTION public.is_admin() RETURNS boolean
    ...
    AS $$
  SELECT COALESCE(
    -- DB-anchored: admin_users
    EXISTS (
      SELECT 1 FROM public.admin_users au
      WHERE au.user_id = COALESCE((nullif(current_setting('request.jwt.claims', true), '')::jsonb ->> 'sub')::uuid, auth.uid())
    )
    OR
    -- Profiles-based admin if the JSON contains role: 'admin' (works even if column doesn't physically exist)
    EXISTS (
      SELECT 1
      FROM public.profiles p
      WHERE p.id = COALESCE((nullif(current_setting('request.jwt.claims', true), '')::jsonb ->> 'sub')::uuid, auth.uid())
        AND (to_jsonb(p)->>'role') = 'admin'
    )
    OR
    -- Legacy behavior: JWT role claim
...
COMMENT ON FUNCTION public.is_admin() IS 'Admin when in public.admin_users, or profiles.role==admin (if exists), or legacy JWT role==admin.';
...
CREATE FUNCTION public.is_quiz_member(p_quiz_id uuid) RETURNS boolean
  ...
  SELECT EXISTS (
    ...
    WHERE qp.quiz_id = p_quiz_id AND qp.user_id = auth.uid()
  );
$$;


--
-- Name: is_username_available(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_username_available(p_username text, p_exclude uuid DEFAULT NULL::uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
declare
  normalized text := nullif(lower(trim(p_username)), '');
begin
...
--
-- Name: FUNCTION is_username_available(p_username text, p_exclude uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) IS 'Returns true if the supplied username is not used by another profile (case-insensitive).';
...
CREATE FUNCTION public.join_quiz(p_quiz_id uuid) RETURNS text
    ...
    AS $$
declare
  v_user uuid := get_my_claim_text('sub')::uuid;
  v_start timestamptz;
  v_end timestamptz;
  v_status text;
  v_fee int := 0;
...
begin
  ...
  select start_time, end_time, status, entry_fee into v_start, v_end, v_status, v_fee from public.quizzes where id = p_quiz_id;
  if not found then raise exception 'Quiz not found'; end if;

  if v_status not in ('active','draft') then
    raise exception 'Quiz not active';
  end if;
  if v_start is not null and v_now < v_start then
    raise exception 'Quiz not active yet';
  end if;
  if v_end is not null and v_now >= v_end then
    raise exception 'Quiz already ended';
  end if;

  -- charge entry fee if required
  if coalesce(v_fee,0) > 0 then
    select coins into v_coins from public.profiles where id = v_user;
    if coalesce(v_coins,0) < v_fee then
      raise exception 'Insufficient balance';
    end if;
    -- debit transaction and update coins once per join (idempotent with unique constraint below)
    -- we will only charge if the insert below actually creates a participant row
  end if;
  ...
  select 1 from ins;  -- consume CTE

  -- if fee and newly joined (no prior row), we need to know if insert happened; fallback: charge only when no existing row
  -- Charge if not already a participant
  if coalesce(v_fee,0) > 0 and not exists (
    select 1 from public.quiz_participants where quiz_id = p_quiz_id and user_id = v_user and joined_at > (now() - interval '5 minutes')
  ) then
    -- If the row existed earlier, skip charging; otherwise, safe to charge now
    if not exists (select 1 from public.quiz_participants where quiz_id = p_quiz_id and user_id = v_user) then
      raise exception 'Unexpected: join failed';
    end if;
    -- To avoid double-charge, ensure no prior join_fee for this quiz
    if not exists (
      select 1 from public.transactions t where t.user_id = v_user and t.type = 'join_fee' and t.description = ('Quiz ' || p_quiz_id)::text
    ) then
      insert into public.transactions(user_id, type, amount, description)
      values (v_user, 'join_fee', -v_fee, ('Quiz ' || p_quiz_id)::text);
      update public.profiles set coins = coins - v_fee where id = v_user;
    end if;
  end if;
...
declare
    q record;
begin
    -- Process quizzes that should be marked as finished
    for q in
    ...
    loop
        ...
        -- Compute results for finished quiz
        perform public.compute_quiz_results(q.id);
    end loop;
    
    -- Process quizzes that should be marked as active
    for q in
        select id from public.quizzes 
...
--
-- Name: profiles_public_by_ids(uuid[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.profiles_public_by_ids(p_ids uuid[]) RETURNS TABLE(id uuid, username text, full_name text, avatar_url text)
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
...
--
-- Name: FUNCTION profiles_public_by_ids(p_ids uuid[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.profiles_public_by_ids(p_ids uuid[]) IS 'Returns limited public profile fields (id, username, full_name, avatar_url) for the supplied user ids.';
...
DECLARE
  v_user uuid := COALESCE(public.get_my_claim_text('sub')::uuid, auth.uid());
  v_endpoint text := COALESCE(p_subscription_object->>'endpoint', '');
BEGIN
  IF v_user IS NULL THEN
    RAISE EXCEPTION 'Not authenticated';
  END IF;
  ...
  -- Delete existing row for same user + endpoint (supports both schemas)
  DELETE FROM public.push_subscriptions
   WHERE user_id = v_user
     AND (
       ...
       OR (subscription_object->>'endpoint') = v_endpoint
     );
...
COMMENT ON FUNCTION public.save_push_subscription(p_subscription_object jsonb) IS 'Saves a web push subscription for the current user. Replaces prior row for same endpoint.';
...
--
-- Name: update_profile_coins(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_profile_coins() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
BEGIN
    -- Update total_coins and total_spent for the user
    UPDATE public.profiles 
    SET 
        total_coins = (
            ...
            AND public._tx_is_credit(type) = true
        ),
        total_spent = (
            SELECT COALESCE(SUM(ABS(amount)), 0) 
            FROM public.transactions 
            WHERE user_id = NEW.user_id 
            AND public._tx_is_credit(type) = false
        )
    WHERE id = NEW.user_id;
...
COMMENT ON TABLE public.admin_users IS 'List of admin users (user_id from auth.users)';
...
CREATE TABLE public.quiz_participants (
    ...
    CONSTRAINT quiz_participants_status_check CHECK ((status = ANY (ARRAY['joined'::text, 'completed'::text, 'disqualified'::text])))
);
...
CREATE TABLE public.quizzes (
    ...
    updated_at timestamp with time zone DEFAULT now(),
    category text,
    CONSTRAINT check_positive_amounts CHECK (((entry_fee >= (0)::numeric) AND (prize_pool >= (0)::numeric))),
    CONSTRAINT check_quiz_times CHECK (((start_time < end_time) AND (end_time <= result_time))),
...
CREATE VIEW public.my_quizzes_view WITH (security_invoker='true', security_barrier='true') AS
 SELECT qp.quiz_id AS id,
    q.title,
    q.category,
    q.start_time,
    q.end_time,
    ...
    q.status,
    q.prizes,
    COALESCE(qp.score, 0) AS my_score,
    qr.leaderboard,
    qr.result_shown_at
  ...
  WHERE (qp.user_id = ( SELECT auth.uid() AS uid));
...
CREATE TABLE public.profiles (
    ...
    CONSTRAINT profiles_non_negative_totals CHECK (((COALESCE(total_coins, (0)::numeric) >= (0)::numeric) AND (COALESCE(total_spent, (0)::numeric) >= (0)::numeric)))
);
...
CREATE TABLE public.push_subscriptions (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone,
    endpoint text GENERATED ALWAYS AS ((subscription_object ->> 'endpoint'::text)) STORED
);
...
CREATE TABLE public.transactions (
    ...
    CONSTRAINT transactions_type_check CHECK ((lower(type) = ANY (ARRAY['credit'::text, 'reward'::text, 'bonus'::text, 'referral'::text, 'daily_login'::text, 'quiz_reward'::text, 'purchase'::text, 'debit'::text, 'refund'::text, 'join_fee'::text, 'prize'::text])))
);
...
00000000-0000-0000-0000-000000000000	761c45ab-1704-4dd0-b52e-8aeb4de08a40	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 02:21:17.615307+00	
00000000-0000-0000-0000-000000000000	34a53cc9-e638-43ab-8f48-6b142d5b4a36	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 02:21:17.645036+00	
00000000-0000-0000-0000-000000000000	a7b3dcad-f459-494d-9e90-01092e0d2329	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-12 11:48:24.838993+00	
00000000-0000-0000-0000-000000000000	750447d1-8e93-49d9-83fe-0a4c519106f8	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-12 11:48:58.854291+00	
00000000-0000-0000-0000-000000000000	6a16aefc-fc7a-4673-8efc-5f543046db61	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 12:36:21.21042+00	
00000000-0000-0000-0000-000000000000	631c719c-cf33-4fb6-939c-848ed3ffd36c	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 12:36:21.231612+00	
00000000-0000-0000-0000-000000000000	4bfd0285-6f82-427d-b2a8-0b3548b3a4b0	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 15:01:25.155551+00	
00000000-0000-0000-0000-000000000000	da5f6569-beb1-415c-a026-cca34e99ffc2	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 15:01:25.170467+00	
00000000-0000-0000-0000-000000000000	6e346c8a-0d34-4aec-b519-c650ad6d931c	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 16:00:07.197626+00	
00000000-0000-0000-0000-000000000000	2d8e8cc0-d8d5-4d5c-81ba-c5616f7f243c	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-12 16:00:07.214858+00	
00000000-0000-0000-0000-000000000000	5ea96f2c-d8c5-4e8c-9a7a-d509496cb121	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 09:06:36.19281+00	
00000000-0000-0000-0000-000000000000	5c048d76-cd00-4635-a2e6-9b7d3dc2732c	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 10:15:48.119642+00	
00000000-0000-0000-0000-000000000000	bbb42d34-938b-415d-b6e3-f2eb0d6893ed	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 11:13:52.422178+00	
00000000-0000-0000-0000-000000000000	a35a05eb-443b-4183-a9d6-1e9f0f6c0b22	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 11:13:52.439049+00	
00000000-0000-0000-0000-000000000000	8f04e6ae-3f66-4843-b481-ca38e94733f7	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 12:16:43.473948+00	
00000000-0000-0000-0000-000000000000	8f62b14f-c508-4d9d-a195-d74930f3c47e	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 12:16:43.492956+00	
00000000-0000-0000-0000-000000000000	73a790e9-a291-4479-b83f-a79635f386e2	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 12:16:46.179504+00	
00000000-0000-0000-0000-000000000000	516a9fd9-0b3f-47f8-b4bd-572038a904b3	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 13:15:22.15482+00	
00000000-0000-0000-0000-000000000000	709f1260-ba4f-4912-8a79-2e28df8476f0	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 13:15:22.169692+00	
00000000-0000-0000-0000-000000000000	b9e5e29b-0441-4d56-ac30-0690d00289d8	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 13:15:48.460487+00	
00000000-0000-0000-0000-000000000000	c20b8c78-cb64-41cb-8f0b-1c4837ef688a	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 13:21:47.965694+00	
00000000-0000-0000-0000-000000000000	ed3b0b4f-48d8-43f8-a23e-e0e929230dde	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 13:23:57.925972+00	
00000000-0000-0000-0000-000000000000	c53c5c52-b22f-4eea-9ef0-81603b578a1c	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 13:30:10.157087+00	
00000000-0000-0000-0000-000000000000	6e62ff19-4555-4778-9472-5ec6bfdf0368	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 14:06:06.157928+00	
00000000-0000-0000-0000-000000000000	a23ac777-3b66-4c52-982e-cbb4df4cd439	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 14:29:09.353679+00	
00000000-0000-0000-0000-000000000000	dfd8fb45-3c24-4bc8-8426-232d731b06c4	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 14:29:09.358873+00	
00000000-0000-0000-0000-000000000000	e8c0523b-7232-40c3-903d-67db300d35eb	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 14:42:48.046132+00	
00000000-0000-0000-0000-000000000000	30879842-463b-43dd-9658-ffae22ca0db3	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 14:49:10.179569+00	
00000000-0000-0000-0000-000000000000	342a449e-41f6-440f-a16b-a0ef9c187d54	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 15:02:00.603979+00	
00000000-0000-0000-0000-000000000000	3753920e-18dc-4b1f-8e47-5298193ed472	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 15:03:16.672326+00	
00000000-0000-0000-0000-000000000000	7fdfb876-1728-45b8-b503-5fafa62e11a7	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 15:06:22.59685+00	
00000000-0000-0000-0000-000000000000	ee7ce04b-b440-44f6-bbed-39a101454a79	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 15:33:24.11516+00	
00000000-0000-0000-0000-000000000000	2f360639-7486-4fc0-b05a-01aa94308688	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 16:05:04.131859+00	
00000000-0000-0000-0000-000000000000	e0dbc4a9-247b-49d0-a4d1-66d1fba51993	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 16:05:04.148528+00	
00000000-0000-0000-0000-000000000000	8592c45e-71fa-4eab-972a-c1c2bd19b8e8	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 16:16:15.657595+00	
00000000-0000-0000-0000-000000000000	b5d007f9-f309-4104-bef4-f0a7a7baeb40	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 16:30:28.270587+00	
00000000-0000-0000-0000-000000000000	9a757c05-5e79-471a-9c56-8f4204f128f4	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 16:36:41.335011+00	
00000000-0000-0000-0000-000000000000	7854bb18-fbd0-48a7-b255-9e5a49b1d350	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 17:06:57.953376+00	
00000000-0000-0000-0000-000000000000	7df777b8-3d69-4334-9290-523f1b15d270	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 17:13:26.472551+00	
00000000-0000-0000-0000-000000000000	7b04c7ea-1256-4fdf-86f5-7a09991ea216	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 17:21:46.974569+00	
00000000-0000-0000-0000-000000000000	d6a0e87f-2f8f-43ce-8633-fe2aa3aa471b	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 17:23:50.660893+00	
00000000-0000-0000-0000-000000000000	11fe48b9-de7f-4045-811a-9269f12df03e	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 18:05:49.581294+00	
00000000-0000-0000-0000-000000000000	a1bb6110-6fa0-4c92-a9fe-16ea02fa032c	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 18:21:56.940034+00	
00000000-0000-0000-0000-000000000000	1a1bca91-9d88-433f-ada7-ddd0fe4bdde0	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-20 18:21:56.950898+00	
00000000-0000-0000-0000-000000000000	0c020002-de97-4ee4-aadd-9c190d4cef53	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-20 18:42:24.331087+00	
00000000-0000-0000-0000-000000000000	57aa70ea-8cb1-45b5-9358-273b2704207d	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 18:43:47.594731+00	
00000000-0000-0000-0000-000000000000	50c677b2-6d5b-4873-9f4c-8dd3903976d2	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 18:48:25.812996+00	
00000000-0000-0000-0000-000000000000	045ba5dc-0065-468a-8286-8782bed0373c	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-20 19:02:37.812226+00	
00000000-0000-0000-0000-000000000000	b3d236e3-8500-44ac-aa14-b9aa9abb4eb6	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-21 03:29:23.193311+00	
00000000-0000-0000-0000-000000000000	39371c4b-ba52-4ba3-816a-f0ffd1b9f349	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 04:27:55.696016+00	
00000000-0000-0000-0000-000000000000	48d3abcc-b0eb-4eeb-9cb6-62fdd6d39e6e	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 04:27:55.716483+00	
00000000-0000-0000-0000-000000000000	7f8c74a6-cd2c-4310-b587-d7c7629e9c99	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 05:27:05.779256+00	
00000000-0000-0000-0000-000000000000	5ee4752b-1ded-4969-9e56-4c030a977f5a	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 05:27:05.801815+00	
00000000-0000-0000-0000-000000000000	94eb00aa-5db3-4beb-8de9-558a3a2760d7	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 14:39:56.996822+00	
00000000-0000-0000-0000-000000000000	436e2b69-9a7d-415f-8c7d-5869c2b8a610	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 14:39:57.030123+00	
00000000-0000-0000-0000-000000000000	2f1d2887-ccf0-472c-971f-ff72a89afba4	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 15:39:00.338537+00	
00000000-0000-0000-0000-000000000000	53a8536c-b099-4023-8a65-369cb39f4547	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-21 15:39:00.359253+00	
00000000-0000-0000-0000-000000000000	3bd1027d-4953-4f4d-b073-f852d61bfff5	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 07:57:27.235147+00	
00000000-0000-0000-0000-000000000000	bc92c604-d9b4-494b-951b-f2afecc52ab8	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 08:00:07.73047+00	
00000000-0000-0000-0000-000000000000	266c2f50-0886-499d-a76c-c2d6b67efc94	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:22:22.743077+00	
00000000-0000-0000-0000-000000000000	178bd758-8061-4a0d-97a2-e6b461f95373	{"action":"user_recovery_requested","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"user"}	2025-09-22 08:28:11.579609+00	
00000000-0000-0000-0000-000000000000	a3da0ca7-09f6-4302-8a70-6937c4e202ac	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:29:04.322304+00	
00000000-0000-0000-0000-000000000000	f187f1dc-7378-4307-afc9-d18a057e5885	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:31:45.933975+00	
00000000-0000-0000-0000-000000000000	9a13048b-3e57-4db8-b89c-457e7b5cf473	{"action":"user_recovery_requested","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"user"}	2025-09-22 08:33:15.305408+00	
00000000-0000-0000-0000-000000000000	436b6805-128c-4cb6-9630-25553ed39095	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:33:31.505693+00	
00000000-0000-0000-0000-000000000000	11a0f4b8-0dcf-496b-bf50-81d20f97203a	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:42:24.047693+00	
00000000-0000-0000-0000-000000000000	eceddea4-12e9-494e-8979-f0fe7d856a87	{"action":"user_recovery_requested","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"user"}	2025-09-22 08:42:31.792209+00	
00000000-0000-0000-0000-000000000000	45f8d7a4-9c8b-45b0-8bee-54ada048c32e	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 08:42:49.33479+00	
00000000-0000-0000-0000-000000000000	9d543b17-d155-4cb1-8889-5c8404cb8f97	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 09:42:13.713837+00	
00000000-0000-0000-0000-000000000000	2fd0cb9e-f19f-4fc0-803f-5c08056b471e	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 09:50:48.240545+00	
00000000-0000-0000-0000-000000000000	450b8504-c569-4b1b-9819-3d4b3cb27d3e	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 10:42:05.972619+00	
00000000-0000-0000-0000-000000000000	20eca1e8-c87a-42a1-815b-00304fc2f997	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 10:42:05.996656+00	
00000000-0000-0000-0000-000000000000	0c7d6ac0-2c51-4382-b977-c9f15e45be02	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 10:46:02.892049+00	
00000000-0000-0000-0000-000000000000	29fa83de-a667-465c-834f-048306f5d937	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 11:05:00.819409+00	
00000000-0000-0000-0000-000000000000	d1a396a7-7062-4302-8bee-0879e1e3f08d	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"google"}}	2025-09-22 11:08:58.747793+00	
00000000-0000-0000-0000-000000000000	8bce179e-6143-42b3-9b7b-e794d9b6cabc	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 11:09:19.660924+00	
00000000-0000-0000-0000-000000000000	eb8a25eb-536f-4604-b1c9-9fe61f8b55bd	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 11:09:59.863251+00	
00000000-0000-0000-0000-000000000000	7337f699-c2ac-48a1-9adb-ceac356e0014	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 11:10:47.213309+00	
00000000-0000-0000-0000-000000000000	7ba18231-3b0f-4286-af13-34ba30f7225a	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 13:45:29.536744+00	
00000000-0000-0000-0000-000000000000	a0bd48d8-3c90-46ae-9a0c-560b3b6239fd	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 14:47:35.674036+00	
00000000-0000-0000-0000-000000000000	01067e63-3027-4fd1-953a-10abfd6ad79e	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 14:47:35.701989+00	
00000000-0000-0000-0000-000000000000	8309e570-0a23-4060-8c20-6138fa932770	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 15:46:37.027165+00	
00000000-0000-0000-0000-000000000000	009a8575-03e1-4e59-b3ad-e9456f473d0d	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 15:46:37.033542+00	
00000000-0000-0000-0000-000000000000	45ff9add-226d-490d-8e1a-b1f3783491e0	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 16:45:33.834664+00	
00000000-0000-0000-0000-000000000000	7253f152-ad10-487c-bcde-d6aeceee9f1c	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 16:45:33.849002+00	
00000000-0000-0000-0000-000000000000	4bf36461-9343-4dea-a03a-020fee9131dc	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 17:07:01.302265+00	
00000000-0000-0000-0000-000000000000	9d80b832-2286-4fc8-a449-5e38c7ba22bc	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 17:28:42.250316+00	
00000000-0000-0000-0000-000000000000	f816d936-1df9-4c89-b104-6814a845e9b2	{"action":"login","actor_id":"0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf","actor_username":"finprimebusiness@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 17:30:48.858115+00	
00000000-0000-0000-0000-000000000000	91c1523b-ac9f-466a-a7cf-70e01792f2ab	{"action":"logout","actor_id":"0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf","actor_username":"finprimebusiness@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 17:41:26.296091+00	
00000000-0000-0000-0000-000000000000	2b22cd13-bc64-4bfa-bd8a-e5ed7ea003da	{"action":"login","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"google"}}	2025-09-22 17:43:09.596219+00	
00000000-0000-0000-0000-000000000000	f7437292-fe55-444f-8c7f-f31b227638cf	{"action":"token_refreshed","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 18:42:38.648859+00	
00000000-0000-0000-0000-000000000000	bcd151e6-be0f-42c7-8654-c2a8b4b2587d	{"action":"token_revoked","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-22 18:42:38.65884+00	
00000000-0000-0000-0000-000000000000	581d0b5c-a115-432d-9e4b-9bf98ee541b0	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 18:44:39.539434+00	
00000000-0000-0000-0000-000000000000	ef130255-128a-44f5-b5d9-52e58046bde4	{"action":"logout","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 18:45:23.948858+00	
00000000-0000-0000-0000-000000000000	d9b5fef4-98f3-4613-947c-3f43bc319759	{"action":"login","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"google"}}	2025-09-22 18:45:29.562142+00	
00000000-0000-0000-0000-000000000000	b31286a8-c649-491b-b018-e5faecf2b0ff	{"action":"logout","actor_id":"c9bac630-48da-42ef-b8ca-68797ed6d652","actor_name":"Govind","actor_username":"quizdangalofficial@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 18:45:44.395212+00	
00000000-0000-0000-0000-000000000000	5edc480c-ca5e-40d7-91a6-b80e888bd77c	{"action":"login","actor_id":"0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf","actor_username":"finprimebusiness@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 18:46:09.254904+00	
00000000-0000-0000-0000-000000000000	3a35b9ac-ee00-4123-a9d8-a122c10a88b7	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-22 19:06:20.27986+00	
00000000-0000-0000-0000-000000000000	8fee335a-9c67-45c7-94be-42d21bdf19eb	{"action":"logout","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account"}	2025-09-22 19:07:28.768362+00	
00000000-0000-0000-0000-000000000000	67d10ac0-58f0-4e03-bfb9-4cf2d77063e4	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-23 01:59:22.094+00	
00000000-0000-0000-0000-000000000000	97b21eae-43aa-4c7e-a9da-43067facf1c6	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-23 04:42:54.573734+00	
00000000-0000-0000-0000-000000000000	8e919d4c-b42c-4aa8-8960-e7b9f8fb812a	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-23 04:42:54.590706+00	
00000000-0000-0000-0000-000000000000	14b5a501-b51d-4899-bb0b-67175c35c712	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-23 06:29:12.779837+00	
00000000-0000-0000-0000-000000000000	093c91a1-10af-4888-b26b-42f93d5bfc26	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-23 06:29:12.803635+00	
00000000-0000-0000-0000-000000000000	d4f07bc9-5176-4726-9367-73744e756448	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-24 04:02:26.457155+00	
00000000-0000-0000-0000-000000000000	aaee6d2d-b220-4de3-bf84-b6bb15543e11	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-24 04:02:26.478413+00	
00000000-0000-0000-0000-000000000000	7d9c5ad9-82f0-4d1a-85a8-6cdaf5cf3f64	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-29 15:20:19.941274+00	
00000000-0000-0000-0000-000000000000	0183d1cb-b8ad-4ad6-8ffd-475be4df75a8	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 16:19:10.568108+00	
00000000-0000-0000-0000-000000000000	65afb0f4-e860-4227-986d-2ff922d7074b	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 16:19:10.57881+00	
00000000-0000-0000-0000-000000000000	ed06d38e-64c5-47cb-a34d-35d619f14660	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 17:38:59.716954+00	
00000000-0000-0000-0000-000000000000	3bf299b7-95ec-4219-b4eb-491197671644	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 17:38:59.729976+00	
00000000-0000-0000-0000-000000000000	0d9dfb34-673e-4fb2-a8c1-c80671d2e91f	{"action":"login","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}	2025-09-29 18:02:07.1212+00	
00000000-0000-0000-0000-000000000000	32bb7ced-dc9f-4010-a60f-b49f9d163ff9	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 18:37:38.011363+00	
00000000-0000-0000-0000-000000000000	e815f3e6-cd7f-4a5a-a5e6-5dc2e8ded484	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 18:37:38.035928+00	
00000000-0000-0000-0000-000000000000	3cbebfac-c27e-4954-98c5-1282e2bf285e	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:00:38.043584+00	
00000000-0000-0000-0000-000000000000	7fa3989d-f627-41c0-8cef-c7853527c23b	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:00:38.054808+00	
00000000-0000-0000-0000-000000000000	0063c151-3648-45fc-863c-ad4cec10e752	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:36:40.604227+00	
00000000-0000-0000-0000-000000000000	4be855ab-f0e7-4355-8359-9cc32d4d259f	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:36:40.63053+00	
00000000-0000-0000-0000-000000000000	f473f4ab-59b4-41a7-be5c-c9658c564371	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:59:39.359668+00	
00000000-0000-0000-0000-000000000000	8e30d6df-0979-4e14-a413-02ac2aa10c7b	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 19:59:39.387907+00	
00000000-0000-0000-0000-000000000000	d248dd0c-7d51-4fce-9182-3feb92176ad2	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 20:35:14.117727+00	
00000000-0000-0000-0000-000000000000	7534f2b0-6196-4990-81f2-414da63c7606	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 20:35:14.129731+00	
00000000-0000-0000-0000-000000000000	fe51f6bc-77e4-4086-9cef-82a51dc5dd5c	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 20:58:39.851056+00	
00000000-0000-0000-0000-000000000000	ceb4c22f-6c00-4a81-b823-8e84c0c3c75e	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 20:58:39.878782+00	
00000000-0000-0000-0000-000000000000	f6c622f1-fa3a-4874-806b-881bd6571439	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 21:34:36.43281+00	
00000000-0000-0000-0000-000000000000	93c3d6fb-41ba-4411-97f3-dc6051a00c27	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-29 21:34:36.444201+00	
00000000-0000-0000-0000-000000000000	09ba9803-8158-48f7-b1c5-840d17106cc9	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 01:02:36.280615+00	
00000000-0000-0000-0000-000000000000	fc720266-f703-4cf9-a7c5-ae46a750ef70	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 01:02:36.314143+00	
00000000-0000-0000-0000-000000000000	a1dde819-4c1f-4951-ace8-0b6ba7d63db0	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 02:39:07.373498+00	
00000000-0000-0000-0000-000000000000	978d569d-2dc2-41af-963e-f8f84a0960ec	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 02:39:07.402562+00	
00000000-0000-0000-0000-000000000000	254700ee-1e50-442f-a494-8d5afe35659a	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 03:37:48.787523+00	
00000000-0000-0000-0000-000000000000	10c16c9b-abac-4496-9b24-a3d9ae38113f	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 03:37:48.805645+00	
00000000-0000-0000-0000-000000000000	e44b8956-5780-4484-af8d-2822630d3b26	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 04:37:03.085033+00	
00000000-0000-0000-0000-000000000000	cd2a258f-4f85-42e9-b5ca-c9a85a67772c	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 04:37:03.096577+00	
00000000-0000-0000-0000-000000000000	e6e1257b-de4a-4162-b0b4-ca0a8a5ae88d	{"action":"token_refreshed","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 05:36:04.891424+00	
00000000-0000-0000-0000-000000000000	1feeb115-4539-4592-962a-b0737f88b239	{"action":"token_revoked","actor_id":"d54f5f83-aa63-4630-b9be-dbdca91b9315","actor_name":"Govind","actor_username":"sutharji1122@gmail.com","actor_via_sso":false,"log_type":"token"}	2025-09-30 05:36:04.901379+00	
\.
...
8572a9d9-b9f7-4f17-96a3-0f0947d40757	2025-09-22 18:46:09.259316+00	2025-09-22 18:46:09.259316+00	password	d2c7a798-aec4-489e-a2cb-a08ea2c723a3
e1496b3d-ef53-441b-9dbc-f01f49bc5145	2025-09-23 01:59:22.201636+00	2025-09-23 01:59:22.201636+00	password	ad10c2bd-74c7-40fb-8826-d96186800a94
b5b3a68e-15c0-47ba-9aa5-6b0555f7763f	2025-09-29 15:20:20.004205+00	2025-09-29 15:20:20.004205+00	password	b0274bb2-86b7-4863-88b7-3829162db950
097df421-998a-4e6c-afc2-f4522592be48	2025-09-29 18:02:07.160577+00	2025-09-29 18:02:07.160577+00	password	7f3b1b86-dbed-4a9f-8a1d-95ecc392dc15
\.
...
00000000-0000-0000-0000-000000000000	449	xawmdpxddmmi	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-23 01:59:22.156197+00	2025-09-23 04:42:54.593335+00	\N	e1496b3d-ef53-441b-9dbc-f01f49bc5145
00000000-0000-0000-0000-000000000000	450	tu5jbcrzqdjc	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-23 04:42:54.609308+00	2025-09-23 06:29:12.806252+00	xawmdpxddmmi	e1496b3d-ef53-441b-9dbc-f01f49bc5145
00000000-0000-0000-0000-000000000000	451	xvrmukev5ttj	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-23 06:29:12.834628+00	2025-09-24 04:02:26.483911+00	tu5jbcrzqdjc	e1496b3d-ef53-441b-9dbc-f01f49bc5145
00000000-0000-0000-0000-000000000000	452	oy7af6lvbbvt	d54f5f83-aa63-4630-b9be-dbdca91b9315	f	2025-09-24 04:02:26.500488+00	2025-09-24 04:02:26.500488+00	xvrmukev5ttj	e1496b3d-ef53-441b-9dbc-f01f49bc5145
00000000-0000-0000-0000-000000000000	453	ssp57eoocpwc	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 15:20:19.971446+00	2025-09-29 16:19:10.583151+00	\N	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	454	xx6qmsf3s567	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 16:19:10.593566+00	2025-09-29 17:38:59.733286+00	ssp57eoocpwc	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	455	xtblodnrd4t3	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 17:38:59.751273+00	2025-09-29 18:37:38.039186+00	xx6qmsf3s567	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
...
00000000-0000-0000-0000-000000000000	456	pebl6kdfbjtw	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 18:02:07.148431+00	2025-09-29 19:00:38.057084+00	\N	097df421-998a-4e6c-afc2-f4522592be48
00000000-0000-0000-0000-000000000000	457	2py63qm4prrl	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 18:37:38.065098+00	2025-09-29 19:36:40.634397+00	xtblodnrd4t3	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	458	54j446oqe3o2	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 19:00:38.064772+00	2025-09-29 19:59:39.392968+00	pebl6kdfbjtw	097df421-998a-4e6c-afc2-f4522592be48
00000000-0000-0000-0000-000000000000	459	jhpezzdeuqtc	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 19:36:40.662826+00	2025-09-29 20:35:14.137361+00	2py63qm4prrl	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	460	n3l447x4v3ba	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 19:59:39.410492+00	2025-09-29 20:58:39.881013+00	54j446oqe3o2	097df421-998a-4e6c-afc2-f4522592be48
00000000-0000-0000-0000-000000000000	462	f7e5n7rczuwu	d54f5f83-aa63-4630-b9be-dbdca91b9315	f	2025-09-29 20:58:39.901849+00	2025-09-29 20:58:39.901849+00	n3l447x4v3ba	097df421-998a-4e6c-afc2-f4522592be48
00000000-0000-0000-0000-000000000000	461	keyaxlwst72z	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 20:35:14.143915+00	2025-09-29 21:34:36.446753+00	jhpezzdeuqtc	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	463	5umkgbwyfb4v	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-29 21:34:36.463075+00	2025-09-30 01:02:36.320476+00	keyaxlwst72z	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	464	gmzfzxezhl4f	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-30 01:02:36.349131+00	2025-09-30 02:39:07.405984+00	5umkgbwyfb4v	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	465	grnyrr27sk2m	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-30 02:39:07.42211+00	2025-09-30 03:37:48.808174+00	gmzfzxezhl4f	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	466	p3hbtiflgh2l	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-30 03:37:48.819113+00	2025-09-30 04:37:03.098563+00	grnyrr27sk2m	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	467	3leyxu5wqnlv	d54f5f83-aa63-4630-b9be-dbdca91b9315	t	2025-09-30 04:37:03.107076+00	2025-09-30 05:36:04.903374+00	p3hbtiflgh2l	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	468	bbxgpo4sfmyt	d54f5f83-aa63-4630-b9be-dbdca91b9315	f	2025-09-30 05:36:04.912138+00	2025-09-30 05:36:04.912138+00	3leyxu5wqnlv	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
00000000-0000-0000-0000-000000000000	447	7xoibv7fdsbg	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	f	2025-09-22 18:46:09.257955+00	2025-09-22 18:46:09.257955+00	\N	8572a9d9-b9f7-4f17-96a3-0f0947d40757
\.
...
8572a9d9-b9f7-4f17-96a3-0f0947d40757	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	2025-09-22 18:46:09.257085+00	2025-09-22 18:46:09.257085+00	\N	aal1	\N	\N	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	42.107.224.128	\N
e1496b3d-ef53-441b-9dbc-f01f49bc5145	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-23 01:59:22.128499+00	2025-09-24 04:02:26.522487+00	\N	aal1	\N	2025-09-24 04:02:26.521271	Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Mobile Safari/537.36 OPR/85.0.0.0	42.105.48.66	\N
...
097df421-998a-4e6c-afc2-f4522592be48	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-29 18:02:07.137031+00	2025-09-29 20:58:39.921779+00	\N	aal1	\N	2025-09-29 20:58:39.921094	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	42.107.224.132	\N
b5b3a68e-15c0-47ba-9aa5-6b0555f7763f	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-29 15:20:19.959051+00	2025-09-30 05:36:04.926944+00	\N	aal1	\N	2025-09-30 05:36:04.925701	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	42.107.224.132	\N
\.
...
00000000-0000-0000-0000-000000000000	c9bac630-48da-42ef-b8ca-68797ed6d652	authenticated	authenticated	quizdangalofficial@gmail.com	\N	2025-08-16 14:53:28.494136+00	\N		\N		\N			\N	2025-09-22 18:45:29.563714+00	{"is_admin": true, "provider": "google", "providers": ["google"]}	{"iss": "https://accounts.google.com", "sub": "106847980397139222112", "name": "Govind", "email": "quizdangalofficial@gmail.com", "picture": "https://lh3.googleusercontent.com/a/ACg8ocKq00BwNSRBkOGLU04snbVIgYuuXZ_9GF1efcMkou8bac9y3xM=s96-c", "full_name": "Govind", "avatar_url": "https://lh3.googleusercontent.com/a/ACg8ocKq00BwNSRBkOGLU04snbVIgYuuXZ_9GF1efcMkou8bac9y3xM=s96-c", "provider_id": "106847980397139222112", "email_verified": true, "phone_verified": false}	\N	2025-08-16 14:53:28.402422+00	2025-09-22 18:45:29.56753+00	\N	\N			\N		0	\N		\N	f	\N	f
00000000-0000-0000-0000-000000000000	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	authenticated	authenticated	finprimebusiness@gmail.com	$2a$10$Fk7KsvaVI79s4fe5YFdfAeIk1V3QTsrFgbJT5nNW8URoMK7ryKo12	2025-08-29 04:46:33.028416+00	\N		\N		\N			\N	2025-09-22 18:46:09.256996+00	{"provider": "email", "providers": ["email"]}	{"sub": "0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf", "email": "finprimebusiness@gmail.com", "email_verified": true, "phone_verified": false}	\N	2025-08-29 04:46:33.005581+00	2025-09-22 18:46:09.258957+00	\N	\N			\N		0	\N		\N	f	\N	f
00000000-0000-0000-0000-000000000000	d54f5f83-aa63-4630-b9be-dbdca91b9315	authenticated	authenticated	sutharji1122@gmail.com	$2a$10$2FLTxBVrZh3j6vtwBT8H7ORjUx6mw5KG4vgojUfZnTsTX/IM05JV6	2025-08-23 14:49:34.875525+00	\N		\N		2025-09-22 08:42:31.799935+00			\N	2025-09-29 18:02:07.136934+00	{"provider": "email", "providers": ["email", "google"]}	{"iss": "https://accounts.google.com", "sub": "118002990807929691971", "name": "Govind", "email": "sutharji1122@gmail.com", "picture": "https://lh3.googleusercontent.com/a/ACg8ocIQKyDRHmvc2KvzlvpD3URLqVHjjxPTsl1pkuGfpieEsXdzejo=s96-c", "full_name": "Govind", "avatar_url": "https://lh3.googleusercontent.com/a/ACg8ocIQKyDRHmvc2KvzlvpD3URLqVHjjxPTsl1pkuGfpieEsXdzejo=s96-c", "provider_id": "118002990807929691971", "email_verified": true, "phone_verified": false}	\N	2025-08-23 14:49:34.758992+00	2025-09-30 05:36:04.91881+00	\N	\N			\N		0	\N		\N	f	\N	f
\.
...
COPY public.admin_users (user_id, created_at) FROM stdin;
c9bac630-48da-42ef-b8ca-68797ed6d652	2025-09-30 03:51:11.128632+00
\.
...
91687f1e-80a0-4451-8700-1ff1ff00cf31	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-29	10	1	2025-09-29 16:13:06.132521+00
...
cab54180-ccde-4d2c-bacd-112d1db9222c	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-30	15	2	2025-09-30 02:39:10.428195+00
...
e25dac4b-9c71-4f11-be09-be009d56b827	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-20	10	1	2025-09-20 09:06:39.69727+00
efc2b8f9-3bbd-4a91-b3cf-8f936ed9a8e5	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-21	15	2	2025-09-21 03:29:26.321256+00
de3a9e4e-973a-4739-8667-fd82c8e06d86	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-22	20	3	2025-09-22 07:57:29.64821+00
bf78c49f-8b75-4b5f-a02b-d2b7069e1d51	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	2025-09-22	1	1	2025-09-22 17:30:50.740939+00
8d971bec-8f4f-4c87-9526-80b552c2dfe6	c9bac630-48da-42ef-b8ca-68797ed6d652	2025-09-22	10	1	2025-09-22 17:43:14.638847+00
822d26ac-6f78-455b-87bb-7bdb1ef22bf7	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-23	25	4	2025-09-23 01:59:25.238635+00
\.
...
COPY public.levels (level, coins_required) FROM stdin;
1	50
2	200
3	450
4	800
...
COPY public.options (id, question_id, option_text, updated_at, is_correct) FROM stdin;
\.
...
COPY public.profiles (id, full_name, role, updated_at, email, total_spent, quizzes_played, quizzes_won, account_status, created_at, username, avatar_url, is_profile_complete, notification_enabled, referral_code, referred_by, current_streak, max_streak, last_login_date, mobile_number, total_coins, level) FROM stdin;
2ff275bd-7b73-4ff7-8a3d-d6a49b57259e	Kartik Suthar	user	2025-09-30 05:46:54.580933+00	\N	0	0	0	active	2025-09-05 12:16:35.193191+00	Kartik		t	f	2FF275BD	\N	1	1	2025-09-05		20	0
c9bac630-48da-42ef-b8ca-68797ed6d652	Govind	admin	2025-09-30 05:46:54.580933+00	quizdangalofficial@gmail.com	0	0	0	active	2025-08-25 18:10:32.747001+00	admin	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/c9bac630-48da-42ef-b8ca-68797ed6d652/1756746475867.webp	t	f	C9BAC630	\N	1	2	2025-09-22		20	0
0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf		user	2025-09-30 05:46:54.580933+00	finprimebusiness@gmail.com	0	0	0	active	2025-08-30 18:18:25.28617+00	rdsharma	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf/1756577912545.jpg	t	f	0BA6D7CB	\N	1	1	2025-09-11	9376778504	31	0
d54f5f83-aa63-4630-b9be-dbdca91b9315	Govind	user	2025-09-30 06:15:04.07966+00	sutharji1122@gmail.com	0	0	0	active	2025-08-25 18:08:53.554728+00	gomu4300000	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/d54f5f83-aa63-4630-b9be-dbdca91b9315/1756577551350.jpg	t	f	d54f5f83	\N	2	5	2025-09-30	8696154913	215	2
\.
...
COPY public.push_subscriptions (id, user_id, subscription_object, created_at, updated_at) FROM stdin;
\.
...
c930b74d-8553-4b3a-83d8-8140a0165f30	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	10	success	2025-09-20 09:06:39.69727+00	2025-09-20 09:06:39.69727+00	Daily login streak day 1	\N
0b5a30c3-c1f8-4e7e-bf41-e954094440ad	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	15	success	2025-09-21 03:29:26.321256+00	2025-09-21 03:29:26.321256+00	Daily login streak day 2	\N
8c6db101-1553-44e0-9977-fa86e91c0528	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	20	success	2025-09-22 07:57:29.64821+00	2025-09-22 07:57:29.64821+00	Daily login streak day 3	\N
b6f2918c-9b53-4542-a416-daa706c6b113	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	daily_login	1	success	2025-09-22 17:30:50.740939+00	2025-09-22 17:30:50.740939+00	Daily login streak day 1	\N
669f8662-b710-43ee-b4a9-4df378a9a4f4	c9bac630-48da-42ef-b8ca-68797ed6d652	daily_login	10	success	2025-09-22 17:43:14.638847+00	2025-09-22 17:43:14.638847+00	Daily login streak day 1	\N
b7ac8f23-3f54-469f-9b02-050f702b65fa	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	25	success	2025-09-23 01:59:25.238635+00	2025-09-23 01:59:25.238635+00	Daily login streak day 4	\N
8a6320ee-dea2-4d37-b26b-21740851eb3c	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	10	success	2025-09-29 16:13:06.132521+00	2025-09-29 16:13:06.132521+00	Daily login streak day 1	\N
6d3bdf9c-f03c-4f46-ab06-9b0cf0a4f062	d54f5f83-aa63-4630-b9be-dbdca91b9315	daily_login	15	success	2025-09-30 02:39:10.428195+00	2025-09-30 02:39:10.428195+00	Daily login streak day 2	\N
\.
...
--
-- Data for Name: messages_2025_09_27; Type: TABLE DATA; Schema: realtime; Owner: -
--
...
20250905041441	2025-09-24 04:02:51
\.
...
39	add-search-v2-sort-support	39cf7d1e6bf515f4b02e41237aba845a7b492853	2025-09-24 04:03:01.741735
40	fix-prefix-race-conditions-optimized	fd02297e1c67df25a9fc110bf8c8a9af7fb06d1f	2025-09-24 04:03:01.77634
41	add-object-level-update-trigger	44c22478bf01744b2129efc480cd2edc9a7d60e9	2025-09-29 16:13:42.091895
42	rollback-prefix-triggers	f2ab4f526ab7f979541082992593938c05ee4b47	2025-09-29 16:13:42.118513
43	fix-object-level	ab837ad8f1c7d00cc0b7310e989a23388ff29fc6	2025-09-29 16:13:42.15257
\.
...
5d8e38fe-0322-4b94-8b1b-15c51afff7d3	avatars	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf/1758562439886-Screenshot 2025-09-21 094438.png	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	2025-09-22 17:33:59.927991+00	2025-09-22 17:33:59.927991+00	2025-09-22 17:33:59.927991+00	{"eTag": "\\"3ca66d81ef9f8c7b09f4ce360862620e\\"", "size": 157985, "mimetype": "image/png", "cacheControl": "max-age=3600", "lastModified": "2025-09-22T17:34:00.000Z", "contentLength": 157985, "httpStatusCode": 200}	33e6dfa3-a0a0-4b5d-ba3f-529e83b875c7	0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf	{}	2
\.
...
SELECT pg_catalog.setval('realtime.subscription_id_seq', 1486, true);
...
--
-- Name: levels levels_coins_required_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.levels
    ADD CONSTRAINT levels_coins_required_key UNIQUE (coins_required);
...
--
-- Name: push_subscriptions uniq_push_sub_user_endpoint; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.push_subscriptions
    ADD CONSTRAINT uniq_push_sub_user_endpoint UNIQUE (user_id, endpoint);
...
--
-- Name: idx_options_correctness; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_options_correctness ON public.options USING btree (question_id, is_correct);
...
CREATE INDEX idx_push_subscriptions_endpoint ON public.push_subscriptions USING btree (((subscription_object ->> 'endpoint'::text)));


--
-- Name: idx_push_subscriptions_subscription_object_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_subscriptions_subscription_object_gin ON public.push_subscriptions USING gin (subscription_object jsonb_path_ops);
...
--
-- Name: idx_quiz_participants_quiz_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quiz_participants_quiz_user ON public.quiz_participants USING btree (quiz_id, user_id);
...
--
-- Name: idx_quiz_results_quiz; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_quizzes_status_times; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quizzes_status_times ON public.quizzes USING btree (status, start_time, end_time);


--
-- Name: idx_quizzes_times; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_quizzes_times ON public.quizzes USING btree (start_time, end_time);
...
--
-- Name: idx_user_answers_scoring; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_answers_scoring ON public.user_answers USING btree (question_id, selected_option_id, user_id);
...
--
-- Name: transactions_unique_quiz_join_debit; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX transactions_unique_quiz_join_debit ON public.transactions USING btree (user_id, reference_id) WHERE ((reference_id IS NOT NULL) AND (type = 'debit'::text) AND (description = 'Quiz entry fee'::text));


--
-- Name: ux_profiles_username_lower; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_profiles_username_lower ON public.profiles USING btree (lower(username));
...
--
-- Name: users trg_handle_new_user; Type: TRIGGER; Schema: auth; Owner: -
--
...
--
-- Name: options trg_options_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_options_updated_at BEFORE UPDATE ON public.options FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: profiles trg_profiles_block_role_change; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_profiles_block_role_change BEFORE UPDATE OF role ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.block_role_change_if_not_admin();


--
-- Name: profiles trg_profiles_generate_referral; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_profiles_generate_referral BEFORE INSERT ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.generate_referral_code();
...
--
-- Name: quizzes trg_quiz_finished_compute; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_quiz_finished_compute AFTER UPDATE OF status ON public.quizzes FOR EACH ROW WHEN (((new.status = 'finished'::text) AND (old.status IS DISTINCT FROM 'finished'::text))) EXECUTE FUNCTION public.trg_quiz_finished_compute();
...
--
-- Name: quiz_participants trg_quiz_participants_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_quiz_participants_updated_at BEFORE UPDATE ON public.quiz_participants FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: quiz_prizes trg_quiz_prizes_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_quiz_prizes_updated_at BEFORE UPDATE ON public.quiz_prizes FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: quiz_results trg_quiz_results_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_quiz_results_updated_at BEFORE UPDATE ON public.quiz_results FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: redemptions trg_redemptions_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_redemptions_updated BEFORE UPDATE ON public.redemptions FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: redemptions trg_redemptions_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_redemptions_updated_at BEFORE UPDATE ON public.redemptions FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: user_answers trg_user_answers_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: user_answers trigger_auto_complete_quiz; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_auto_complete_quiz AFTER INSERT OR UPDATE ON public.user_answers FOR EACH ROW EXECUTE FUNCTION public.auto_complete_quiz_participant();
...
--
-- Name: transactions trigger_update_profile_coins; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_profile_coins AFTER INSERT OR UPDATE ON public.transactions FOR EACH ROW EXECUTE FUNCTION public.update_profile_coins();
...
--
-- Name: user_quiz_stats Leaderboard read (server functions); Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Leaderboard read (server functions)" ON public.user_quiz_stats FOR SELECT TO postgres USING (true);
...
--
-- Name: notifications Notifications read auth; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Notifications read auth" ON public.notifications FOR SELECT TO authenticated USING (true);


--
-- Name: options Options admin delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Options admin delete" ON public.options FOR DELETE TO authenticated USING (public.is_admin());


--
-- Name: options Options admin insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Options admin insert" ON public.options FOR INSERT TO authenticated WITH CHECK (public.is_admin());


--
-- Name: options Options admin update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Options admin update" ON public.options FOR UPDATE TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: options Options read for auth; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Options read for auth" ON public.options FOR SELECT TO authenticated USING (true);


--
-- Name: quiz_participants Participants: insert own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Participants: insert own" ON public.quiz_participants FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: quiz_participants Participants: read own or admin; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Participants: read own or admin" ON public.quiz_participants FOR SELECT TO authenticated USING (((( SELECT auth.uid() AS uid) = user_id) OR ( SELECT public.is_admin() AS is_admin)));


--
-- Name: quiz_participants Participants: update own or admin; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Participants: update own or admin" ON public.quiz_participants FOR UPDATE TO authenticated USING (((( SELECT auth.uid() AS uid) = user_id) OR ( SELECT public.is_admin() AS is_admin))) WITH CHECK (((( SELECT auth.uid() AS uid) = user_id) OR ( SELECT public.is_admin() AS is_admin)));
...
CREATE POLICY "Profiles insert own" ON public.profiles FOR INSERT WITH CHECK ((id = (public.get_my_claim_text('sub'::text))::uuid));
...
--
-- Name: push_subscriptions Push: manage own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Push: manage own" ON public.push_subscriptions TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: questions Questions admin delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: questions Questions admin insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: questions Questions admin update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: questions Questions read for auth; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Questions read for auth" ON public.questions FOR SELECT TO authenticated USING (true);
...
--
-- Name: quizzes Quizzes admin delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Quizzes admin delete" ON public.quizzes FOR DELETE TO authenticated USING (public.is_admin());


--
-- Name: quizzes Quizzes admin insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Quizzes admin insert" ON public.quizzes FOR INSERT TO authenticated WITH CHECK (public.is_admin());


--
-- Name: quizzes Quizzes admin update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Quizzes admin update" ON public.quizzes FOR UPDATE TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: quizzes Quizzes read for auth; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Quizzes read for auth" ON public.quizzes FOR SELECT TO authenticated USING (true);


--
-- Name: redemptions Redemptions own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Redemptions own" ON public.redemptions FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: referrals Referrals own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Referrals own" ON public.referrals FOR SELECT TO authenticated USING (((( SELECT auth.uid() AS uid) = referrer_id) OR (( SELECT auth.uid() AS uid) = referred_id)));
...
CREATE POLICY "Stats access for owners and admins" ON public.user_quiz_stats FOR SELECT TO authenticated USING (((user_id = ( SELECT auth.uid() AS uid)) OR ((( SELECT public.get_my_claim('is_admin'::text) AS get_my_claim))::boolean IS TRUE)));


--
-- Name: transactions Transactions own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Transactions own" ON public.transactions FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "User answers: insert own" ON public.user_answers FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: user_answers User answers: leaderboard read (definer); Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "User answers: leaderboard read (definer)" ON public.user_answers FOR SELECT TO postgres USING (true);
...
CREATE POLICY "User answers: select own" ON public.user_answers FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));
...
CREATE POLICY "User answers: update own" ON public.user_answers FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));
...
--
-- Name: admin_users admin_users_manage_service_role; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_users_manage_service_role ON public.admin_users TO service_role USING (true) WITH CHECK (true);


--
-- Name: admin_users admin_users_read_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY admin_users_read_own ON public.admin_users FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));
...
--
-- Name: quiz_results results_read_admin_or_participant; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY results_read_admin_or_participant ON public.quiz_results FOR SELECT TO authenticated USING ((( SELECT public.is_admin() AS is_admin) OR (EXISTS ( SELECT 1
   FROM public.quiz_participants qp
  WHERE ((qp.quiz_id = quiz_results.quiz_id) AND (qp.user_id = ( SELECT auth.uid() AS uid)))))));
...
--
-- Name: daily_streaks streaks_select_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY streaks_select_own ON public.daily_streaks FOR SELECT TO authenticated USING (((user_id = ( SELECT auth.uid() AS uid)) OR public.is_admin()));
...
--
-- Name: objects Avatars: authenticated read; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: authenticated read" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'avatars'::text));
...
--
-- Name: objects Avatars: user delete own files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: user delete own files" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'avatars'::text) AND (owner = auth.uid())));


--
-- Name: objects Avatars: user insert own files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: user insert own files" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'avatars'::text) AND (owner = auth.uid())));


--
-- Name: objects Avatars: user update own files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: user update own files" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'avatars'::text) AND (owner = auth.uid()))) WITH CHECK (((bucket_id = 'avatars'::text) AND (owner = auth.uid())));
...
--
-- Name: FUNCTION _internal_resolve(query text, variables jsonb, "operationName" text, extensions jsonb); Type: ACL; Schema: graphql; Owner: -
--
...
--
-- Name: FUNCTION resolve(query text, variables jsonb, "operationName" text, extensions jsonb); Type: ACL; Schema: graphql; Owner: -
--
...
--
-- Name: FUNCTION admin_recompute_quiz_results(p_quiz_id uuid); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.admin_recompute_quiz_results(p_quiz_id uuid) TO anon;
GRANT ALL ON FUNCTION public.admin_recompute_quiz_results(p_quiz_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.admin_recompute_quiz_results(p_quiz_id uuid) TO service_role;
...
--
-- Name: FUNCTION auto_complete_quiz_participant(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.auto_complete_quiz_participant() TO anon;
GRANT ALL ON FUNCTION public.auto_complete_quiz_participant() TO authenticated;
GRANT ALL ON FUNCTION public.auto_complete_quiz_participant() TO service_role;


--
-- Name: FUNCTION block_role_change_if_not_admin(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.block_role_change_if_not_admin() TO anon;
GRANT ALL ON FUNCTION public.block_role_change_if_not_admin() TO authenticated;
GRANT ALL ON FUNCTION public.block_role_change_if_not_admin() TO service_role;


--
-- Name: FUNCTION cleanup_old_data(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION compute_results_wrapper(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.compute_results_wrapper() TO anon;
GRANT ALL ON FUNCTION public.compute_results_wrapper() TO authenticated;
GRANT ALL ON FUNCTION public.compute_results_wrapper() TO service_role;
...
--
-- Name: FUNCTION get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer) TO anon;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard(limit_rows integer, offset_rows integer, max_streak_limit integer) TO service_role;


--
-- Name: FUNCTION get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer) TO anon;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_all_time_leaderboard_v2(limit_rows integer, offset_rows integer, max_streak_limit integer) TO service_role;


--
-- Name: FUNCTION get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO anon;
GRANT ALL ON FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_leaderboard(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO service_role;


--
-- Name: FUNCTION get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO anon;
GRANT ALL ON FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_leaderboard_v2(p_period text, limit_rows integer, offset_rows integer, max_streak_limit integer) TO service_role;
...
REVOKE ALL ON FUNCTION public.get_my_claim(claim text) FROM PUBLIC;
...
--
-- Name: FUNCTION get_my_claim_text(claim text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_next_level_info(p_user_id uuid); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.get_next_level_info(p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_next_level_info(p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.get_next_level_info(p_user_id uuid) TO service_role;
...
REVOKE ALL ON FUNCTION public.is_own_profile(p_profile_id uuid) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.is_quiz_member(p_quiz_id uuid) FROM PUBLIC;
...
--
-- Name: FUNCTION is_username_available(p_username text, p_exclude uuid); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) FROM PUBLIC;
GRANT ALL ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) TO anon;
GRANT ALL ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) TO authenticated;
GRANT ALL ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) TO service_role;
...
REVOKE ALL ON FUNCTION public.join_quiz(p_quiz_id uuid) FROM PUBLIC;
...
--
-- Name: FUNCTION profiles_public_by_ids(p_ids uuid[]); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.profiles_public_by_ids(p_ids uuid[]) FROM PUBLIC;
GRANT ALL ON FUNCTION public.profiles_public_by_ids(p_ids uuid[]) TO anon;
GRANT ALL ON FUNCTION public.profiles_public_by_ids(p_ids uuid[]) TO authenticated;
GRANT ALL ON FUNCTION public.profiles_public_by_ids(p_ids uuid[]) TO service_role;
...
REVOKE ALL ON FUNCTION public.save_push_subscription(p_subscription_object jsonb) FROM PUBLIC;
...
--
-- Name: FUNCTION update_profile_coins(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.update_profile_coins() TO anon;
GRANT ALL ON FUNCTION public.update_profile_coins() TO authenticated;
GRANT ALL ON FUNCTION public.update_profile_coins() TO service_role;
...
--
-- Name: TABLE messages_2025_09_27; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_28; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_29; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_09_30; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_10_01; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_10_02; Type: ACL; Schema: realtime; Owner: -
--
...
--
-- Name: TABLE messages_2025_10_03; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict Qp51GipLqa7OSrgmDaX6H63QwBRnIBL73walSyiWaiMyFQRyeYVdjTZ0fsj3DFm
