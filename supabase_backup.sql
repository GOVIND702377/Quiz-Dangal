...
\restrict TYHKHbMCU5MmmSicrFT5VZTNrRNMzHgmr8mVf7n0BluxZN1JQg3MInWGvx7Scda
...
DROP TRIGGER trg_after_referral ON public.referrals;
DROP TRIGGER trg_after_quiz_result ON public.quiz_results;
...
ALTER TABLE ONLY public.levels DROP CONSTRAINT levels_name_key;
...
DROP FUNCTION public.after_referral_check();
DROP FUNCTION public.after_quiz_result_check();
...
COMMENT ON FUNCTION public.is_username_available(p_username text, p_exclude uuid) IS 'Returns true when the supplied username is not used by another profile (case-insensitive).';
...
CREATE FUNCTION public.profiles_public_by_ids(p_ids uuid[]) RETURNS TABLE(id uuid, username text, full_name text, avatar_url text)
    ...
    AS $$
DECLARE
    safe_ids uuid[] := COALESCE(p_ids, ARRAY[]::uuid[]);
BEGIN
    RETURN QUERY
    SELECT p.id, p.username, p.full_name, p.avatar_url
    FROM public.profiles AS p
    WHERE p.id = ANY(safe_ids);
END;
$$;
...
00000000-0000-0000-0000-000000000000	466	p3hbtiflgh2l	d54f5f83-aa63-4630-b9be-dbdca91b9315	f	2025-09-30 03:37:48.819113+00	2025-09-30 03:37:48.819113+00	grnyrr27sk2m	b5b3a68e-15c0-47ba-9aa5-6b0555f7763f
...
b5b3a68e-15c0-47ba-9aa5-6b0555f7763f	d54f5f83-aa63-4630-b9be-dbdca91b9315	2025-09-29 15:20:19.959051+00	2025-09-30 03:37:48.832922+00	\N	aal1	\N	2025-09-30 03:37:48.832826	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36	42.107.224.132	\N
\.
...
c9bac630-48da-42ef-b8ca-68797ed6d652	Govind	admin	2025-09-22 18:45:31.111823+00	quizdangalofficial@gmail.com	0	0	0	{}	active	2025-08-25 18:10:32.747001+00	Bronze	admin	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/c9bac630-48da-42ef-b8ca-68797ed6d652/1756746475867.webp	t	f	C9BAC630	\N	1	2	2025-09-22		20
d54f5f83-aa63-4630-b9be-dbdca91b9315	Govind	user	2025-09-30 04:06:41.193428+00	sutharji1122@gmail.com	0	0	0	{}	active	2025-08-25 18:08:53.554728+00	Silver	gomu4300000	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/d54f5f83-aa63-4630-b9be-dbdca91b9315/1756577551350.jpg	t	f	d54f5f83	\N	2	5	2025-09-30	8696154913	215
0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf		user	2025-09-22 19:02:14.561842+00	finprimebusiness@gmail.com	0	0	0	{}	active	2025-08-30 18:18:25.28617+00	Bronze	rdsharma	https://gcheopiqayyptfxowulv.supabase.co/storage/v1/object/public/avatars/0ba6d7cb-d163-4c8d-81fd-ab37c051d5cf/1756577912545.jpg	t	f	0BA6D7CB	\N	1	1	2025-09-11	9376778504	31
\.
...
--
-- Data for Name: messages_2025_09_26; Type: TABLE DATA; Schema: realtime; Owner: -
--
...
SELECT pg_catalog.setval('realtime.subscription_id_seq', 1477, true);
...
--
-- Name: TABLE messages_2025_09_26; Type: ACL; Schema: realtime; Owner: -
--
...
\unrestrict TYHKHbMCU5MmmSicrFT5VZTNrRNMzHgmr8mVf7n0BluxZN1JQg3MInWGvx7Scda
